...
# extract sepal length and EstimatedSalary length
...
plt.xlabel('Age length [cm]')
plt.ylabel('EstimatedSalary length [cm]')
...
plt.xlabel('Age length [standardized]')
plt.ylabel('EstimatedSalary length [standardized]')
plt.legend(loc='upper left')
